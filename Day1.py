...
def expense_report(expense):
    '''expense is a lsit of integers.  This function will find the
    first two integers that add up to 2020, then multiply those
    numbers and return the result.'''
    
    combos = combinations(expense, 2)
